...
api.signin = function(){
  $('.ui.modal.sign-in').modal({
    onShow: function(){
      ...
      contentWr.load('/login?form=true', function(res, status, xhr){
        if(status == "success"){
...
api.toggleGame = function(){
  wsCtrl.game = !wsCtrl.game;
  rd.game(function(){m.redraw()});
  rd.nav(function(){m.redraw()});
};

module.exports = api;
},{"./_wsCtrl.js":2}],2:[function(require,module,exports){
var wsCtrl = {};
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],4:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
      ...
      {tag: "div", attrs: {}, children: [
        ...
        wsCtrl.userId.length>0?(
            ...
            {tag: "span", attrs: {class:"dock-close", 
              ...
              {tag: "i", attrs: {class:"large remove icon"}}
            ]}, 
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],5:[function(require,module,exports){
var ChatController = require('./_controller.msx');
var ChatView = require('./_view.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],7:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],8:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"./_partial.msx":7}],9:[function(require,module,exports){
var ChatRoomController = require('./_controller.msx');
var ChatRoomView = require('./_view.msx');
...
},{"./_controller.msx":6,"./_view.msx":8}],10:[function(require,module,exports){
"user strict";
...
},{"./chat/chat.msx":5,"./chatroom/chatroom.msx":9,"./footer/footer.msx":11,"./game/game.msx":15,"./home/home.msx":19,"./nav/nav.msx":27,"./qa/qa.msx":31,"./room/room.msx":35,"./user/user.msx":38,"./usersetting/userSetting.msx":42}],11:[function(require,module,exports){
...
var GameController = function(){
  ...
  rd.game(function(){console.log("redraw game!"); m.redraw()});
  
};


module.exports = GameController;
},{"../_api.msx":1,"../_wsCtrl.js":2}],13:[function(require,module,exports){
module.exports=require(12)
},{"../_api.msx":1,"../_wsCtrl.js":2}],14:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
var Partial = require('./_partial.msx');
...
var GameView = function(ctrl) {
  return (
      {tag: "div", attrs: {className:"gameBg " + (wsCtrl.game?"activea":"")}, children: [
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"../room/_partial.msx":33,"./_partial.msx":13}],15:[function(require,module,exports){
var GameController = require('./_controller.msx');
var GameView = require('./_view.msx');
var Game={};
...
module.exports = Game;
},{"./_controller.msx":12,"./_view.msx":14}],16:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],17:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
      ...
      {tag: "div", attrs: {className:"ui home-post-Wr"}, children: [
        {tag: "div", attrs: {className:"ui postContainer postDemo"}, children: [
          ...
          {tag: "div", attrs: {className:"ui horizontal list extra-post"}, children: [
            {tag: "div", attrs: {className:"item"}, children: [
              {tag: "a", attrs: {className:"mini ui  basic button", "data-content":"Thích", "data-position":"top left", 
                 config:function(el, isInited){
                   if(!isInited){
                     $(el)
                         .popup({
            ...
            {tag: "div", attrs: {className:"item"}, children: [
              {tag: "a", attrs: {className:"mini ui basic button", "data-content":"Bình luận", "data-position":"top left", 
                 config:function(el, isInited){
                   if(!isInited){
                     $(el)
                         .popup({
        ...
        {tag: "span", attrs: {className:"right floated post-arrow"}, children: [
            {tag: "a", attrs: {className:"route", "data-content":(m.route.param('postId') === undefined)?"Vào xem":"Quay lại", "data-position":"top left", 
            ...
            }, children: [{tag: "i", attrs: {className:((m.route.param('postId') === undefined)?"large  grey indent":"large  grey reply all") +" icon link-post"}}]}
          ]}
      ]}
  )
};
          ...
          {tag: "div", attrs: {className:"ui home-post-Wr"}, children: [
            {tag: "div", attrs: {className:"ui postContainer postDemo"}, children: [
              ...
              {tag: "div", attrs: {id:"comment"}, children: [
                ...
                {tag: "div", attrs: {className:"ui threaded comments parent-comments"}, children: [
                  {tag: "h2", attrs: {}, children: ["Bình luận"]}, 
                        ...
                        {tag: "div", attrs: {className:"comment"}, children: [
                          ...
                          (comment.replay || comment.children.length > 0)?[
                            (comment.children.length>0)?(
                                {tag: "div", attrs: {className:"comments child-comments"}, children: [
...
module.exports = Partial;
},{"../_api.msx":1,"../_wsCtrl.js":2}],18:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
var Partial = require('./_partial.msx');
var Partial2 = require('../room/_partial.msx');
...
var HomeView = function(ctrl) {
  ...
  {tag: "div", attrs: {className:"ui grid  main-content"}, children: [
    ...
    {tag: "div", attrs: {className:"eight wide column"}, children: [
      {tag: "div", attrs: {className:"ui  home-post-Wr room-chat"}, children: [
        {tag: "div", attrs: {className:"ui segment segWr"}, children: [
          {tag: "div", attrs: {className:"ui padded grid"}, children: [
            {tag: "div", attrs: {className:"sixteen wide  column pad-bot0"}, children: [
              Partial2.Comments(ctrl)
            ]}
          ]}, 
          {tag: "div", attrs: {className:"ui padded grid "}, children: [
            {tag: "div", attrs: {className:"sixteen wide column pad-top0"}, children: [
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"../room/_partial.msx":33,"./_partial.msx":17}],19:[function(require,module,exports){

var HomeController = require('./_controller.msx');
var HomeView = require('./_view.msx');
var Home={};
Home.controller = HomeController;
Home.view =HomeView;

module.exports = Home;
},{"./_controller.msx":16,"./_view.msx":18}],20:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],21:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
module.exports = Partial;
},{"../_api.msx":1,"../_wsCtrl.js":2}],22:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
  ...
  return (
      {tag: "div", attrs: {className:"ui top small blue inverted fixed  menu sha"}, children: [
        {tag: "div", attrs: {className:"ui top small blue inverted fixed  menu sha", style:"width: 1000px;left: 0; right: 0; margin: 0 auto;"}, children: [
          ...
          {tag: "a", attrs: {href:"/qa", "data-content":"Hỏi & Đáp", "data-position":"bottom left", 
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"./_partial.msx":21,"./menu_button/Friend.msx":23,"./menu_button/Login.msx":24,"./menu_button/Message.msx":25,"./menu_button/User.msx":26}],23:[function(require,module,exports){
var wsCtrl = require('../../_wsCtrl.js');
var api = require('../../_api.msx');

var Friend = function(ctrl){ return [
      {tag: "a", attrs: {className:"item nofity  message-button fix-icon", "data-content":"Kết bạn", "data-position":"bottom right", 
                      ...
                      return (
                          {tag: "div", attrs: {className:"notifyFriend clearfix"}, children: [
                            ...
                            {tag: "span", attrs: {className:"mini ui buttons fright"}, children: [
                              {tag: "a", attrs: {href:("/rel/follow/" + friend.id), className:"ui positive button", 
                                onclick:function(e){
                                  e.preventDefault();
                                    $.post($(this).attr('href'),
                                       function(data) {
...
},{"../../_api.msx":1,"../../_wsCtrl.js":2}],24:[function(require,module,exports){
var wsCtrl = require('../../_wsCtrl.js');
var api = require('../../_api.msx');
...
},{"../../_api.msx":1,"../../_wsCtrl.js":2}],25:[function(require,module,exports){
var wsCtrl = require('../../_wsCtrl.js');
var api = require('../../_api.msx');

var MessageButton = function(ctrl){ return [
      {tag: "a", attrs: {className:"item nofity  message-button pre-show-messages fix-icon", "data-content":"Tin nhắn", "data-position":"bottom right", 
...
},{"../../_api.msx":1,"../../_wsCtrl.js":2}],26:[function(require,module,exports){
var wsCtrl = require('../../_wsCtrl.js');
var api = require('../../_api.msx');

var UserButton = function(ctrl){ return [
      {tag: "a", attrs: {href:"javascript:void(0)", className:"item user-button fix-icon", "data-content":"Thông tin cá nhân", "data-position":"bottom center", 
...
},{"../../_api.msx":1,"../../_wsCtrl.js":2}],27:[function(require,module,exports){

var NavController = require('./_controller.msx');
var NavView = require('./_view.msx');
...
module.exports = Nav;
},{"./_controller.msx":20,"./_view.msx":22}],28:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],29:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
        ...
        {tag: "div", attrs: {className:"ui bottom attached segment "}, children: [
          (m.route() !== '/qa/new')?(
              ...
              {tag: "form", attrs: {className:"ui form", method:"post", action:"/qa/new", 
                ...
                {tag: "div", attrs: {className:"field"}, children: [
                  {tag: "label", attrs: {}, children: ["Từa đề"]}, 
                  {tag: "input", attrs: {name:"question", type:"text"}}
                ]}, 
                {tag: "div", attrs: {className:"field"}, children: [
                  {tag: "label", attrs: {}, children: ["Nội dung"]}, 
...
module.exports = Partial;
},{"../_api.msx":1,"../_wsCtrl.js":2}],30:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"./_partial.msx":29}],31:[function(require,module,exports){
var QaController = require('./_controller.msx')
var QaView = require('./_view.msx')
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],33:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
module.exports = Partial;
},{"../_api.msx":1,"../_wsCtrl.js":2}],34:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
var Partial = require('./_partial.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"./_partial.msx":33}],35:[function(require,module,exports){
var RoomController = require('./_controller.msx');
var RoomView = require('./_view.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],37:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],38:[function(require,module,exports){
var UserController = require('./_controller.msx');
var UserView = require('./_view.msx');
...
module.exports = User;
},{"./_controller.msx":36,"./_view.msx":37}],39:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2}],40:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
...
module.exports = Partial;
},{"../_api.msx":1,"../_wsCtrl.js":2}],41:[function(require,module,exports){
var wsCtrl = require('../_wsCtrl.js');
var api = require('../_api.msx');
var Partial = require('./_partial.msx');
...
},{"../_api.msx":1,"../_wsCtrl.js":2,"./_partial.msx":40}],42:[function(require,module,exports){
var UserSettingController = require('./_controller.msx');
var UserSettingView = require('./_view.msx');
...
},{"./_controller.msx":39,"./_view.msx":41}]},{},[10])