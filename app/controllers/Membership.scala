...
object Membership extends LilaController {
  ...
  def subscribe = AuthBody(BodyParsers.parse.tolerantJson) { implicit ctx =>
    me => {
  ...
  def reSubscribe = AuthBody { implicit ctx =>
    me => {
