								...
								<div className="ui two column stackable grid" style="color: white !important; height: 250px;">
									<div className="column">
										<div className="ui breadcrumb">
											<a className="section" style="color: white !important">Home</a>
											<div className="divider" style="color: white !important"> /</div>
											<a className="section" style="color: white !important">Store</a>
											<div className="divider" style="color: white !important"> /</div>
													...
													return (
														<div className="card">
															<div className="blurring dimmable image">
																...
																<img src="https://cdn.lynda.com/courses/485817-636144756016029857_270x480_thumb.jpg"/>
															</div>
															<div className="content">
