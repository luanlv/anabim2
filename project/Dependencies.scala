...
//      ornicarMaven,
  ...
  val RPM = "org.reactivemongo" %% "reactivemongo-play-json" % "0.12-RC3"
...
//  val prismic = "io.prismic" %% "scala-kit" % "1.2.11-THIB"
  ...
  val play_silhouette = "com.mohiva" %% "play-silhouette" % "3.0.0"
//  val play_silhouette_password_bcrypt = "com.mohiva" %% "play-silhouette-password-bcrypt" % "4.0.0"
//  val play_silhouette_persistence = "com.mohiva" %% "play-silhouette-persistence" % "3.0.0"
//  val play_silhouette_crypto_jca = "com.mohiva" %% "play-silhouette-crypto-jca" % "4.0.0"
  val ficus = "net.ceedubs" %% "ficus" % "1.1.2"
  val scala_guice = "net.codingwell" %% "scala-guice" % "4.0.1"
